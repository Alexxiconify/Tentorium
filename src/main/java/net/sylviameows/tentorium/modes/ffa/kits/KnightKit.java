...
public class KnightKit extends Kit {
    public KnightKit() {
        items.put(0, ItemUtilities.createItem(Material.IRON_SWORD, meta -> meta.addEnchant(Enchantment.DAMAGE_ALL, 2, true)));
...
//        items.put(8, ItemUtilities.createItem(Material.COOKED_BEEF, 16));
        ...
        items.put(38, ItemUtilities.createItem(Material.IRON_CHESTPLATE, meta -> meta.addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1, true)));
