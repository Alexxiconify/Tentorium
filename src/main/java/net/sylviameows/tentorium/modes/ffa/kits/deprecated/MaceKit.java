...
public class MaceKit extends Kit {
    public MaceKit() {
        ...
        items.put(1, ItemUtilities.createItem(Material.GOLDEN_APPLE));
        items.put(2, ItemUtilities.createItem(Material.GOLDEN_APPLE));
        items.put(3, ItemUtilities.createItem(Material.GOLDEN_APPLE));
